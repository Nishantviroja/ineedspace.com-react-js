...
export default function Footer() {
    return (
      <>
            ...
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-emerald-600">
                <div className="mr-12 hidden lg:block">
                <span>Get connected with us on social networks:</span>
                </div>
                <div className="flex justify-center">
                <Link to="/" className="mr-6 text-gray-800">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                ...
                <div className="">
                    <h6 className="uppercase font-bold mb-1 flex justify-center md:justify-start">
                    Menu
                    </h6>
                    <p className="mb-1">
                    ...
                    <p className="mb-1">
                    <Link to="/Property" className="text-gray-800">All Property</Link>
                    </p>
                    <p className="mb-1">
                ...
                <div className="">
                    ...
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">House</Link>
                    </p>
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">Commercial</Link>
                    </p>
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">Land</Link>
                    </p>
                ...
                <div className="">
                    ...
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">Buy</Link>
                    </p>
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">Rent</Link>
                    </p>
                    <p className="mb-1">
                    <Link to="/" className="text-gray-800">Buy & Rent</Link>
                    </p>
